...
import get_java_now from "/src/images/gifs/get_java_now.gif";
import hate_squarespace from "/src/images/gifs/hate_squarespace.png";
import vscode_button from "/src/images/gifs/vscode_button.gif";
import powered_by_debian from "/src/images/gifs/powered_by_debian.gif";
import mozilla_gecko from "/src/images/gifs/mozilla_gecko.gif";
import made_with_macos1 from "/src/images/gifs/made_with_macos1.gif";
import lol from "/src/images/gifs/lol.gif";
import hello_kitty from "/src/images/gifs/hello_kitty.gif";
import botao_broda from "/src/images/gifs/botao_broda.png";
import botao_mvg from "/src/images/gifs/botao_mvg.png";
import "./buttonsscroll.css";

function makeButtonObj(btn: string){
	return {alt: btn.toString().toLowerCase(), button: btn}
}
